...
enum
{
	...
	JOYCODE_MENUBTN = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, MENUBTN),
	JOYCODE_CLEARBTN = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, CLEARBTN),
	JOYCODE_CANCELBTN = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, CANCELBTN),

	JOYCODE_HAT1UP = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, HAT1UP),
	JOYCODE_HAT1DOWN = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, HAT1DOWN),
	JOYCODE_HAT1LEFT = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, HAT1LEFT),
	JOYCODE_HAT1RIGHT = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, HAT1RIGHT),
	JOYCODE_HAT2UP = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, HAT2UP),
	JOYCODE_HAT2DOWN = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, HAT2DOWN),
	JOYCODE_HAT2LEFT = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, HAT2LEFT),
	JOYCODE_HAT2RIGHT = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, HAT2RIGHT),
	JOYCODE_HAT3UP = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, HAT3UP),
	JOYCODE_HAT3DOWN = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, HAT3DOWN),
	JOYCODE_HAT3LEFT = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, HAT3LEFT),
	JOYCODE_HAT3RIGHT = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, HAT3RIGHT),
	JOYCODE_HAT4UP = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, HAT4UP),
	JOYCODE_HAT4DOWN = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, HAT4DOWN),
	JOYCODE_HAT4LEFT = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, HAT4LEFT),
	JOYCODE_HAT4RIGHT = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, HAT4RIGHT),
};
